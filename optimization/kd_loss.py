# paste from https://github.com/jongwooko/distillm/blob/master/distillm/losses.py
# checked forward_kl and reverse_kl. forward_kl uses the soft loss which removes the teacher logits -only term.
import torch
